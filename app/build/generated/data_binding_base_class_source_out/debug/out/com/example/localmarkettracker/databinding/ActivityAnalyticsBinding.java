...
public final class ActivityAnalyticsBinding implements ViewBinding {
  ...
  private ActivityAnalyticsBinding(@NonNull LinearLayout rootView, @NonNull Button btnPredict,
      @NonNull Spinner spProduct, @NonNull TextView tvPrediction) {
  ...
  public static ActivityAnalyticsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spProduct;
      Spinner spProduct = ViewBindings.findChildViewById(rootView, id);
      if (spProduct == null) {
        break missingId;
      }
      ...
      return new ActivityAnalyticsBinding((LinearLayout) rootView, btnPredict, spProduct,
          tvPrediction);
    }
