...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull CardView rootView, @NonNull CardView categoryCard,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      CardView categoryCard = (CardView) rootView;
      ...
      return new ItemCategoryBinding((CardView) rootView, categoryCard, categoryIcon, categoryName);
    }
