...
public final class ActivityItemDetailsBinding implements ViewBinding {
  ...
  private ActivityItemDetailsBinding(@NonNull LinearLayout rootView, @NonNull LineChart priceChart,
  ...
  public static ActivityItemDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityItemDetailsBinding((LinearLayout) rootView, priceChart, tvName, tvPrice);
    }
