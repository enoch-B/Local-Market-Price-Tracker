...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull Button btnLogin,
      @NonNull EditText etEmail, @NonNull EditText etPassword, @NonNull ProgressBar progressLogin,
      @NonNull ImageView togglePassword, @NonNull TextView txtForgot, @NonNull TextView txtSignup,
      @NonNull TextView txtWelcomeMessage) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txtWelcomeMessage;
      TextView txtWelcomeMessage = ViewBindings.findChildViewById(rootView, id);
      if (txtWelcomeMessage == null) {
        break missingId;
      }

      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, etEmail, etPassword,
          progressLogin, togglePassword, txtForgot, txtSignup, txtWelcomeMessage);
    }
